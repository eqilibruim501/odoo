...
{
    'name': 'Customize CloudBI OEM (Boost, My Cloud)',
    'version': '13.20.05.10',
    'author': 'Eqilibruim Solutions',
    'category': 'Productivity',
    'website': 'https://www.eqilibruimsolutions.com',
    'license': 'LGPL-3',
    'sequence': 2,
    'summary': """
    1 click customize CloudBI, reset data. For quick develop. Set brand, boost, reset data, debug. Language Switcher.
    Easy Delete data.reset account chart.
    customize my ERP.
    """,
    'description': """

    App Customize CloudBI (Change Title,Language,Documentation,Quick Debug)
    ============
    White label CloudBI.
    Support CloudBI 13, 12, 11, 10, 9.
    You can config odoo, make it look like your own platform.
    1. Deletes CloudBI label in footer
